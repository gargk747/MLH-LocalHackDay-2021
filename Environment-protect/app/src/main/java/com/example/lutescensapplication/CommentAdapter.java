...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder> {
    ...
    public CommentAdapter(Context mContext, List<Comment> mComment, String taskId) {
        ...
        viewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (comment.getPublisher().equals(firebaseUser.getUid())){
                    ...
                    alertDialog.setMessage("are you sure you want to delete the comment?");
                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Yes",
                            new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    FirebaseDatabase.getInstance().getReference("Comments").child(taskId)
    ...
    void getUserInfo(final ImageView imageView, final TextView username, String publisherid){
